...
export const metadata: Metadata = { title: "Motion SVG — редактор анимации иконок", description: "Импортируйте SVG, анимируйте отдельные слои и скачивайте автономный файл." };
